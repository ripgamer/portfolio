    ...
    return (
        ...
        >
            <div id='page1-in' className='absolute py-11 px-16 w-full'>
                <img className='h-20 ' src='./src/assets/img/ak.png' alt='' />
                <Tilttext r={tiltRef}/>
            ...
            <div className='h-full w-full shadow-black shadow-lg bg-[url(./src/assets/img/akbg.png)] sm:bg-cover bg-contain rounded-[40px]'></div>
